 ...
 * easily be modified for extended for custom page decorations.
 ...
 * 
paper color - default color is white, can be changed using the system
 * property org.icepdf.core.views.page.paper.color
 * 

 * 
paper border color - default color is black, can be changed using the
 * system property org.icepdf.core.views.page.border.color

 * 
paper shadow color - default color is darkGrey, can be changed using the
 * system property org.icepdf.core.views.page.shadow.color

 * 

 * 
All color values can be set using the hex rgb values.
 * eg. black=000000 or white=FFFFFFF. 
